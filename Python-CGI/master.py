...
x=os.system("sshpass -p {0} ssh -o stricthostkeychecking=no -l root {1}  hadoop namenode -format -Y".format(Pass,Ip))
print(x)

x=subprocess.getoutput("sshpass -p {0} ssh -o StrictHostKeyChecking=no -l root {1} hadoop-daemon.sh start namenode".format(Pass,Ip))
print(x)
...
x=subprocess.getoutput("sshpass -p {0} ssh -o StrictHostKeyChecking=no -l root {1} jps | grep NameNode".format(Pass,Ip))
print(x)
print("</pre>")
